 ...
 * @author Manoela
 */
public class guiProcedimento extends javax.swing.JInternalFrame {

    /**
     * Creates new form guiProcedimento
     */
    public guiProcedimento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lstProcedimento = new javax.swing.JList();
        ...
        jScrollPane1.setViewportView(lstProcedimento);
    ...
    private void bntGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntGravarActionPerformed
        ...
        new ProcedimentoJpaController().create(p);

        JOptionPane.showMessageDialog(null,"Procedimento cadastrado");
        txtCodigo.setText("");
        txtDescricao.setText("");
        lstProcedimento.removeAll();
        List l = new ProcedimentoJpaController().getProcedimento();
        lstProcedimento.setListData(l.toArray()); 
        txtCodigo.grabFocus(); // #Retorna o foco#
    ...
    private javax.swing.JList lstProcedimento;
